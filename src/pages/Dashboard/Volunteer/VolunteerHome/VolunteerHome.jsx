  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-red-50 to-white dark:from-[#1a0c0c] dark:to-[#0d0b0b] p-6 md:p-10  overflow-hidden flex flex-col justify-center rounded-2xl">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        {/* Total Funds */}
        <div className="bg-white/80 dark:bg-gray-900/70 backdrop-blur-xl border border-green-200/20 dark:border-gray-700/20 rounded-3xl p-8 shadow-lg hover:shadow-xl transition relative overflow-hidden">
          <div className="flex items-center space-x-4">
